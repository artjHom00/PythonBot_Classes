...
main_menu = Menu("Основное меню", buttons=["Создать комнату", "Доступные комнаты", "Игра",  "Первая кнопка меню", "Вторая кнопка меню", "Об авторе", "Получить оскорбление", "Курс доллара", "Курс евро", "Получить анекдот", ])
highlow_menu = Menu("Игра", buttons=["Выше", "Ниже"])
room_menu = Menu("Начать игру", buttons=["Начать игру"])